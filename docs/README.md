...
- [project-index.md](project-index.md): architecture, ownership, and behavior map
...
- Keep local-only notes such as `docs/demo-speaker-notes.md` and `docs/static-accounts-local.md` out of the shared onboarding flow.
